...
@WebServlet(name = "chattingPlatform", urlPatterns = {"/chattingPlatform"})
public class chattingPlatform extends HttpServlet {
...
String username,tempName;
            ...
            throws ServletException, IOException 
    {
        ...
        try (PrintWriter out = response.getWriter()) 
        {
         ...
         //Display Chat Room
         out.println("<html>  <head> <body bgcolor=\"darkgoldenrod\"> <meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"> <title>Chat Room</title>  </head>");
         ...
         out.println("<br><br> <a href=\"chattingPlatform\">Refresh Chat Page</a>");
         out.println("<br>  <br>");
         out.println("Chats:");
         out.println("<br><br>");
        ...
        if(request.getParameter("txtMsg")!=null)
         {
           ...
           try
           {
                ...
                java.sql.Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/mbabane","root","");
              
                Statement st=con.createStatement();
             
                
                String sql = "insert into chat_users values ('"+username+"','"+message+"')";
